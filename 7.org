...
*** 7.4. Strings
 ...
 过程: (string-ci<=? string1 string2 string3 ...)
 过程: (string-ci>=? string1 string2 string3 ...)
 返回: #t if the relation holds, #f otherwise
 库: (chezscheme)

 These predicates are identical to the Revised6 Report counterparts, except they are extended to accept one or more rather than two or more arguments. When passed one argument, each of these predicates 返回 #t.
 ...
 返回: string or the empty string
 库: (chezscheme)

 string must be mutable. n must be an exact nonnegative fixnum not greater than the length of string. If n is zero, string-truncate! 返回 the empty string. Otherwise, string-truncate! destructively truncates string to its first n characters and 返回 string.
 ...
 返回: #t if obj is a mutable string, #f otherwise
 过程: (immutable-string? obj)
 返回: #t if obj is an immutable string, #f otherwise
 库: (chezscheme)
 ...
 返回: an immutable string equal to string
 库: (chezscheme)
...
*** 7.5. Vectors
 ...
 返回: #t if vector is changed, #f otherwise
 库: (chezscheme)
 ...
 返回: #t if obj is a mutable vector, #f otherwise
 过程: (immutable-vector? obj)
 返回: #t if obj is an immutable vector, #f otherwise
 库: (chezscheme)
 ...
 返回: an immutable vector equal to vector
 库: (chezscheme)
...
*** 7.6. Fixnum-Only Vectors
 ...
 过程: (fxvector? obj)
 返回: #t if obj is an fxvector, #f otherwise
 库: (chezscheme)
 ...
 过程: (fxvector fixnum ...)
 返回: an fxvector of the fixnums fixnum ...
 库: (chezscheme)
 ...
 返回: the number of elements in fxvector
 库: (chezscheme)
 ...
 返回: the nth element (zero-based) of fxvector
 库: (chezscheme)
 ...
 返回: a list of the elements of fxvector
 库: (chezscheme)
 ...
 返回: an fxvector of the elements of list
 库: (chezscheme)
 ...
 返回: #t if obj is a mutable fxvector, #f otherwise
 过程: (immutable-fxvector? obj)
 返回: #t if obj is an immutable fxvector, #f otherwise
 库: (chezscheme)
 ...
 返回: either an immutable copy of fxvector or fxvector itself
 库: (chezscheme)
